            ...
            <div className="col-lg-4">
              <div className="footer_link_wrapper d-flex justify-content-between justify-content-lg-around">
                <ul className="footer_links">
                  <li>
                    <Link href="pages/about.html" passHref>About</Link>
                  </li>
                  <li>
                    <Link href="#" passHref>Testimonials</Link>
                  </li>
                  <li>
                    <Link href="#" passHref>Features</Link>
                  </li>
                </ul>

                <ul className="footer_links">
                  <li>
                    <Link href="pages/episod.html" passHref>Episodes</Link>
                  </li>
                  <li>
            ...
            <div className="col-lg-4 ">
              <div className="footer_add d-flex flex-column justify-content-end">
                ...
                <div className="add_wrapper">
                  <Link href="https://podcasts.google.com/" passHref>
                    <Image
                  ...
                  <Link href="https://open.spotify.com/" passHref>
                    <Image
                  ...
                  <Link href="https://www.youtube.com/" passHref>
                    <Image
                      src="/images/icon/Youtube_logo.png"
                      alt=""
                      width={130}
                      height={20}
                    />
